...
// based off of a passed in value.
//The param value passed in will be added in the unit test. If the param value is 'green' set colorResponse variable
//to 'Green is okay'. If the param value is 'red' set reponse variable to 'I heart red'.
